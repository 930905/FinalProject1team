...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>  
          ...
          <div class="row">
              ...
              <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  <div class="footer-widget">
                      <div class="logo mb30">
                          <a href="index.html"><img src="/resources/images/ft-logo.png" class="img-responsive" alt=""></a>
                      </div>
  ...
  <!-- footer close -->
    ...
    <script src="/resources/js_main/jquery.min.js" type="text/javascript"></script>
    <!-- Include all compiled plugins (below), or include individual files as needed -->
    <script src="/resources/js_main/bootstrap.min.js" type="text/javascript"></script>
    <script src="/resources/js_main/menumaker.js" type="text/javascript"></script>
    <!-- 
    ...
    <script type="text/javascript" src="/resources/js_main/owl.carousel.min.js"></script>
    <script type="text/javascript" src="/resources/js_main/slider.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/swiper@10/swiper-bundle.min.js"></script>
    <script src="/resources/js_main/jquery.bxslider.min.js"></script>